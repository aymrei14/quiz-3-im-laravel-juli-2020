    ...
    <form role="form" action="/proyek" method="POST">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror
                <textarea class="form-control" id="desc" rows="3" placeholder="Your description here..." name="desc">{{ old('desc', '') }}</textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror
                <input type="date" class="form-control" id="dl"  name="dl" value="{{ old('dl', '') }}">
            </div>
            <div class="form-group">
